...
version=formatted_time+","+get_random_url('主频道/今日推台.txt')
about="xiaoranmuze,"+get_random_url('主频道/今日推台.txt')

daily_mtv="今日推荐,"+get_random_url('主频道/今日推荐.txt')
daily_mtv1="🔥低调,"+get_random_url('主频道/今日推荐.txt')
daily_mtv2="🔥使用,"+get_random_url('主频道/今日推荐.txt')
daily_mtv3="🔥禁止,"+get_random_url('主频道/今日推荐.txt')
daily_mtv4="🔥贩卖,"+get_random_url('主频道/今日推荐.txt')
...
# 将合并后的文本写入文件
output_file = "output/live.txt"
output_file_simple = "output/live_lite.txt"
others_file = "output/others.txt"

# custom定制 将合并后的文本写入文件
output_file_custom = "output/custom.txt"
...
try:
    ...
    with open(output_file_custom, 'w', encoding='utf-8') as f:
        for line in all_lines_custom:
            f.write(line + '\n')
    print(f"合并后的文本已保存到文件: {output_file_custom}")
...
make_m3u(output_file_simple, output_file_simple.replace(".txt", ".m3u"))
make_m3u(output_file_custom, output_file_custom.replace(".txt", ".m3u"))
