...
version=formatted_time+",https://vd3.bdstatic.com/mda-nia9gqywiryyn8pk/576p/h264/1662878654763005591/mda-nia9gqywiryyn8pk.mp4"
# 定义输出目录为 output 并自动创建
output_dir = "output"
os.makedirs(output_dir, exist_ok=True)  # 自动创建目录，避免路径不存在错误
...
make_m3u(output_file, "output/live.m3u")
make_m3u(output_file_simple, "output/live_lite.m3u")
