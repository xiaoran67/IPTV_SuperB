...
if __name__ == "__main__":
    ...
    input_file1 = os.path.join(parent2_dir, 'output', 'live.txt')  # 输入文件路径1
    input_file2 = os.path.join(current_dir, 'blacklist_auto.txt')  # 输入文件路径2 
    input_file3 = os.path.join(parent2_dir, 'output', 'others.txt')  # 输入文件路径1
    ...
    for statistics in url_statistics: #查看各个url的量有多少 2025-08-19
        print(statistics)
